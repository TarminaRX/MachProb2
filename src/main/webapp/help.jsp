<%@page contentType="text/html" pageEncoding="UTF-8" %>
  <%@ page import="net.rnzonly.mtwo.models.UserFolio" %>
    <% UserFolio user=(UserFolio)session.getAttribute("currentUser"); if(user !=null &&
      user.user_role().contains("admin")) { response.sendRedirect("admin.jsp"); return; } else if
      ...
      <body class="bg-neutral-900 text-white">
        ...
        <div id="mainContainer" class="flex h-screen w-full relative">
          ...
          <main id="postContainer" class="flex-1 flex flex-col h-full max-w-3xl mx-auto border-x border-neutral-800">
            ...
            <!-- Help content with scrollable area -->
            <div id="helpContent" class="overflow-y-auto flex-1 p-4">
              <div class="mb-6">
                <h2 class="text-xl font-bold mb-2">Contact Support</h2>
                <p class="text-neutral-400">Need help? Use the form below to send a message to our admin team. We'll do
                  our
                  best to respond within 24 hours.</p>
              </div>
