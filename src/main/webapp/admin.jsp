      ...
      <body class="bg-neutral-900 text-white">
        ...
        <div id="mainContainer" class="flex h-screen w-full relative">
          ...
          <main id="postContainer" class="flex-1 flex flex-col h-full max-w-3xl mx-auto border-x border-neutral-800">
            ...
            <!-- Users List -->
            <div class="flex-1 border-b border-neutral-800 p-4 overflow-y-auto custom-scrollbar">
              <!-- Placeholder for users list -->
              <div id="usersList" class="space-y-4">
              </div>
            </div>

            <!-- Support Messages Mini Box -->
            <div class="flex-1 p-4 border-b border-neutral-800 custom-scrollbar">
              <h2 class="text-lg font-bold mb-4">Recent Support Messages</h2>
