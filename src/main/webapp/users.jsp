      ...
      <body class="bg-neutral-900 text-white">
        ...
        <div id="mainContainer" class="flex h-screen w-full relative">
          ...
          <main id="postContainer" class="flex-1 flex flex-col h-full max-w-3xl mx-auto border-x border-neutral-800">
            ...
            <!-- User management content - scrollable -->
            <div class="overflow-y-auto flex-1 p-4">
              <section id="followUserBlock" class="bg-neutral-800 rounded-xl p-4 mb-6">
              </section>


              <section id="followingBlockMain" class="mb-6">
                <h2 class="text-lg font-bold mb-4">You're Following</h2>
              </section>
